...
const OurStuff = () => {
    ...
    return (
        <div className={`px-4 xl:px-[140px] 2xl:px-[240px] my-14 black ${theme} md:my-24 mode ${theme}   bg-[#f7f7f7] p-8 md:p-20`}>
            <div className='flex  flex-col md:flex-row  justify-center'>
                <div className='md:w-1/3 p-6'>
                    ...
                    <p className={`mt-10 text-[#827a8e]  mode ${theme}`}>
                    ...
                    <p className={`mt-7 text-[#827a8e]  mode ${theme}`}>
                    ...
                    >
                        {
                            stuffs.map(stuff => <SwiperSlide
                                key={stuff.id}
                            >
                                <div className={`flex items-center flex-col justify-center text ${theme}`}>
                                    <div>
                                        <img src={stuff.image} className='rounded border-8 border-[#fff]' />
                                    </div>
                                    <div className='bg-[#fff] md:w-[50%] md:h-48 -mt-12 p-6 rounded'>
