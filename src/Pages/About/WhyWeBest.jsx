...
const WhyWeBest = () => {
    return (
        <div className='px-4 xl:px-[140px] 2xl:px-[240px] my-14 md:my-24 bg-[#111] h-[600px]'>
            ...
            <div className='flex items-center justify-center mt-12'>
                <div className='text-white text-center space-y-4 w-1/3 p-20 hover:bg-[#ef1721] duration-700'>
                ...
                <div className='text-white text-center space-y-4 w-1/3 border-l hover:border-[#ef1721] hover:border-none p-20 hover:bg-[#ef1721] duration-700'>
                ...
                <div className='text-white text-center space-y-4 w-1/3 p-20 hover:bg-[#ef1721] duration-700 border-l hover:border-[#ef1721]'>
