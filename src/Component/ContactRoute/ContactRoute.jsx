    ...
    return (
        <div>
            ...
            <div className='w-full banner  relative text-left' >
                ...
                <h1 className='font-extrabold text-6xl pt-52 text-left mx-12'> <span >Contact</span> <span className="text-red-500">Us</span> </h1>
                <p className='w-96 text-left mx-12 mt-8' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus excepturi minus exercitationem eos sed modi dolorum cumque sunt facere reprehenderit?</p>
            </div>
            ...
            <div className='bg-slate-200 absolute -mt-12 grid md:grid-cols-3  gap-4 mb-12 mx-12 p-8 font-serif'>
                ...
                <div>
                   <h1 className='text-3xl font-bold text-left '>Get in <span className='text-red-500'>Touch</span></h1>
                   <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem alias velit nihil voluptatum unde rerum, veniam deleniti praesentium accusamus suscipit?</p>
                   <p>Learn more...</p>
                </div>
                ...
                <div>
                  ...
                  <p>atiq@gmail.com</p>
                  <p >Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem, eligendi!</p>
                </div>
            </div>
        </div>
      ...
      <div className="text-center mt-8">
        ...
        <p className="text-gray-600 text-xl mt-3">Get in touch</p>
