...
const Navbar = () => {
    ...
    return (
        <nav>
            {/* Navbar first part */}
            <div className='flex flex-col xl:flex-row gap-2 bg-[#111] text-white items-center justify-center md:justify-between px-4 md:px-[240px] py-4'>
                {/* Info part */}
                ...
                <div className='flex items-center justify-center gap-6'>
                    ...
                    {user ? <>
                        ...
                        <>
                            <Link to='/login' className='flex items-center gap-2 text-sm md:text-lg hover:text-[#ef1721] duration-300'> <span> < FaArrowRight /> </span> Login</Link>
                        </>
                    ...
                    <div className='flex items-center justify-center gap-4 ml-6'>
                        ...
                        <span className='text-sm lg:text-lg hover:text-[#ef1721] duration-500 cursor-pointer'> < FaFacebookF /> </span>
                        <span className='text-sm lg:text-lg hover:text-[#ef1721] duration-500 cursor-pointer'> < FaTwitter /> </span>
                        <span className='text-sm lg:text-lg hover:text-[#ef1721] duration-500 cursor-pointer'>< FaInstagram /></span>
                        <span className='text-sm lg:text-lg hover:text-[#ef1721] duration-500 cursor-pointer'> < FaLinkedinIn /> </span>
                    </div>
                </div>
            </div>
            {/* Navbar second part */}
                    {/* todo - mohosin*/}
            <div className='flex hidden items-center justify-between mx-[240px]'>
