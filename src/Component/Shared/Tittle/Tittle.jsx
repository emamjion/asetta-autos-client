...
const Tittle = ({topTitle, boldblackTitle, boldredTitle}) => {
    return (
        <div className="mx-auto text-black text-center md:w-4/12 my-8">
            <p className="text-[#ef1721] uppercase font-bold flex justify-center "><BsCarFront className='mt-1 mr-2'></BsCarFront> {topTitle}</p>
            <h1 className="text-4xl uppercase py-4 font-bold">{boldblackTitle} <span className='text-[#ef1721]'>{boldredTitle}</span></h1>
