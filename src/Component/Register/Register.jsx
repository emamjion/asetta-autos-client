...
const Register = () => {
    ...
    //                 .then(() => {
    //                     const usersInfo = { name: data.name, email: data.email, image: data.photoUrl}
            ...
            <div>
                <div className="hero min-h-screen  text-black font-bold text-xl ">
                    ...
                    <div className="hero-content flex-col">
                        <div className="card w-[450px] flex-shrink-0 shadow-2xl bg-transparent card-background">
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text"  {...register("photoUrl", { required: true })} name='photoUrl' placeholder="Photo Url" className="input input-bordered bg-transparent" />
                                    {errors.name && <span className='text-red-600'>Url field is required</span>}
                                </div>
                                <div className="form-control">
                                    <label className="label">
