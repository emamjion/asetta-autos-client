    ...
    return (
        <div className='px-4 xl:px-[140px] 2xl:px-[240px] my-14 md:my-24'>
            <div className='flex items-center flex-col'>
                ...
                <hr className='border border-[#ef1721] w-16 mt-2'/>
                <h1 className='font-medium text-3xl my-3'>Where to Next</h1>
            ...
            <div className='mt-12 grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div className='border p-6 flex gap-3'>
                    <span className='text-4xl text-[#ef1721]'> < FaCarAlt /> </span>
                    <div>
                        ...
                        <div className='mt-2'>
                            <Link className='text-[#ef1721] font-medium'>Search cars for sale</Link>
                        </div>
                    </div>
                </div>
                <div className='border p-6 flex gap-3'>
                    <span className='text-4xl text-[#ef1721]'> < HiOutlineDocumentText /> </span>
                    <div>
                        ...
                        <div className='mt-2'>
                            <Link className='text-[#ef1721] font-medium'>Compare what's out there</Link>
                        </div>
                    </div>
                </div>
                <div className='border p-6 flex gap-3'>
                    <span className='text-4xl text-[#ef1721]'> < FaNewspaper /> </span>
                    <div>
                        ...
                        <div className='mt-2'>
                            <Link className='text-[#ef1721] font-medium'>Get the latest</Link>
                        </div>
                    </div>
                </div>
                <div className='border p-6 flex gap-3'>
                    ...
                    <div>
                        ...
                        <div className='mt-2'>
                            <Link className='text-[#ef1721] font-medium'>Sell your car your way</Link>
                        </div>
                    </div>
                </div>
                <div className='border p-6 flex gap-3'>
