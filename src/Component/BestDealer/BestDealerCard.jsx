...
const BestDealerCard = ({ Dealer }) => {
    ...
    return (
        <Link to={`dealer-details/${_id}`}><div className="card mx-auto font-bold w-full relative bg-white text-black shadow-xl px-1 py-3  hover: duration-500 hover:-translate-y-2 cursor-pointer">
        <figure>
            <img src={image} alt="Shoes" className=" rounded-xl w-full bg-red-50 mx-auto px-5" />
        </figure>
        <div>
        ...
        <div className="card-body px-auto">
            <h2 className="card-title hover:underline">{dealerName}</h2>
